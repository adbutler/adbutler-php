 ...
 * @property 		int vast_channel
 * @property 		int vast_zone
 */
class VASTChannelZoneAssignment extends SingleResource
{
    protected static $type = 'vast_channel_zone_assignment';
    protected static $url  = 'vast-channel-zone-assignments';
     ...
     *
     * @return VASTChannelZoneAssignment
