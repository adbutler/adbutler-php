...
class ManagerTest extends SingleResourceTestCase
{
    ...
    public function createRequestData( $data = array() ) {
        return array(
            ...
            'position'                => null,
            'notes'                   => null,
            'can_manage_publishers'   => key_exists('can_manage_publishers'  , $data) ? $data['can_manage_publishers']   : array(1,2,3),
            ...
            'can_view_assigned_stats' => key_exists('can_view_assigned_stats', $data) ? $data['can_view_assigned_stats'] : true,
        );
    }
